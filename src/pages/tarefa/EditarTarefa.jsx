          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1} margin={2}>
                <Button size="small" variant="contained" onClick={handleEditar} color='success'>Salvar</Button>
              </Grid>  
              <Grid item xs={1} margin={2}>  
                <Button size="small" variant="contained" onClick={handleCloseEditar} color='error'>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
